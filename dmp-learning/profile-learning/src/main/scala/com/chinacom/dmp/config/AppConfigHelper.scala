package com.chinacom.dmp.config

import com.chinacom.dmp.untils.DateUtil
import com.typesafe.config.ConfigFactory

object AppConfigHelper {

	// 加载属性配置文件，默认情况下加载application.*文件
	...
	lazy val AD_MAIN_TABLE_NAME = s"$ODS_PREFIX$DELIMITER$AD_INFO_TABLE_NAME$DELIMITER${DateUtil.getTodayDate()}"
